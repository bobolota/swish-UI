...
import { Badge } from '@swish/ui'; // Assure-toi que les imports viennent bien du package UI
import { Button } from '@swish/ui';

export function TournamentHero({ tournament, onRegister, isRegistered = false }) {
  if (!tournament) return null;

  // 1. Dictionnaire pour traduire et colorer les statuts Supabase
  const statusConfig = {
  ...
  return (
    <div className="bg-white rounded-3xl p-6 md:p-10 border border-slate-200 shadow-sm relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        ...
        {/* Partie Gauche : Infos du tournoi */}
